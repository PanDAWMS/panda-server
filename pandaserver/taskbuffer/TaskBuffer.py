...
class TaskBuffer:
    ...
    def getJobIDsInTimeRange(self, dn, timeRangeStr):
        ...
        maxRange = datetime.datetime.now(datetime.UTC) - datetime.timedelta(days=30)
        ...
        if timeRange < datetime.datetime.now(datetime.UTC) - datetime.timedelta(days=2, hours=21):
            # get ArchiveDBproxy
            proxy = self.proxyPool.getProxy()
            # get JobIDs
