    ...
    def checkSubDatasetsInJobset(self):
        ...
        for jobSpec in jobs:
            ...
            if len(subDatasets) > 0:
                ...
                if notFinish != 0:
                    _logger.debug("{0} related sub dataset {1} from {2} has {3} unfinished files".format(self.pandaID, subDataset, jobSpec.PandaID, notFinish))
