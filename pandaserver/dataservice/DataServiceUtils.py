    ...
    for tmpSiteName in siteMapper.getCloud(cloudKey)["sites"]:
        ...
        for tmpSiteDQ2ID in ddm_endpoints:
            ...
            for tmpDQ2ID in replicaMap[tmpDsName]:
                ...
                if (
                    "_SCRATCHDISK" in tmpDQ2ID
                    or "_USERDISK" in tmpDQ2ID
                    or "_PRODDISK" in tmpDQ2ID
                    or "_LOCALGROUPDISK" in tmpDQ2ID
                    or "_LOCALGROUPTAPE" in tmpDQ2ID
                    or "TAPE" in tmpDQ2ID
                    or "_DAQ" in tmpDQ2ID
                    or "_TMPDISK" in tmpDQ2ID
                    or "_TZERO" in tmpDQ2ID
                ):
                    continue
                # check DQ2 prefix
