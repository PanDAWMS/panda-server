...
class TestDataCarouselAPI(unittest.TestCase):
    ...
    def test_change_staging_destination_by_request_id(self) -> None:
    ...
    def test_change_staging_destination_by_dataset(self) -> None:
        url = f"{api_url_ssl}/data_carousel/change_staging_destination"
        print(f"Testing URL: {url}")
    ...
    def test_change_staging_source_by_request_id(self) -> None:
    ...
    def test_change_staging_source_by_dataset(self) -> None:
        url = f"{api_url_ssl}/data_carousel/change_staging_source"
        print(f"Testing URL: {url}")
        data = {"dataset": DATASET}
        status, output = self.http_client.post(url, data)
    ...
    def test_force_to_staging_by_request_id(self) -> None:
    ...
    def test_force_to_staging_by_dataset(self) -> None:
        url = f"{api_url_ssl}/data_carousel/force_to_staging"
        print(f"Testing URL: {url}")
        data = {"dataset": DATASET}
        status, output = self.http_client.post(url, data)
...
class TestDataCarouselAsyncAPI(unittest.TestCase):
    ...
    def _submit(self, method: str, data: dict[str, Any]) -> tuple[int, Any]:
    ...
    def _assert_submitted(self, output: dict[str, Any]) -> str:
    ...
    def _poll(self, async_id: str) -> dict[str, Any]:
    ...
    def test_submit_without_target(self) -> None:
    ...
    def test_submit_change_staging_destination_by_request_id(self) -> None:
    ...
    def test_submit_change_staging_source_by_request_id(self) -> None:
        self._require(REQUEST_ID, "REQUEST_ID")
    ...
    def test_submit_force_to_staging_by_dataset(self) -> None:
    ...
    def test_submit_retire_unused_by_request_id(self) -> None:
        self._require(REQUEST_ID, "REQUEST_ID")
...
class TestDataCarouselTargetValidation(unittest.TestCase):
    ...
    def test_non_numeric_request_id(self) -> None:
    ...
    def test_request_id_as_string_accepted(self) -> None:
    ...
    def test_dataset_only(self) -> None:
...
class TestDataCarouselIddsSubmission(unittest.TestCase):
    ...
    def _dcif(self, related_tasks: list[int], failing_task_ids: tuple[int, ...] = ()) -> mock.MagicMock:
        dcif = mock.MagicMock()
        ...
        def submit(task_id: int, dc_req_spec: Any) -> int:
    ...
    def test_all_submissions_succeed(self) -> None:
    ...
    def test_failed_submission_is_reported(self) -> None:
    ...
    def test_thread_pool_is_bounded(self) -> None:
        sizes = []
...
class TestDataCarouselAsyncHandlers(unittest.TestCase):
    ...
    def _run_with_operation(self, operation: Callable[..., Any]) -> mock._Call:
    ...
    def test_success_stored_as_done(self) -> None:
        operation = mock.MagicMock(return_value=(True, "ok", {"request_id": 123}))
    ...
    def test_operation_failure_stored_as_done_and_never_retried(self) -> None:
    ...
    def test_exception_stored_as_non_retriable_failure(self) -> None:
    ...
    def test_unknown_operation_stored_as_non_retriable_failure(self) -> None:
