...
def main(tbuf=None, **kwargs):
    ...
    timeLimitU = datetime.datetime.now(datetime.timezone.utc) - datetime.timedelta(minutes=30)
    timeLimitL = datetime.datetime.now(datetime.timezone.utc) - datetime.timedelta(days=3)
    ...
    timeLimitRU = datetime.datetime.now(datetime.timezone.utc) - datetime.timedelta(hours=3)
    timeLimitRL = datetime.datetime.now(datetime.timezone.utc) - datetime.timedelta(hours=12)
    timeLimitU = datetime.datetime.now(datetime.timezone.utc) - datetime.timedelta(hours=6)
    timeLimitL = datetime.datetime.now(datetime.timezone.utc) - datetime.timedelta(days=14)
