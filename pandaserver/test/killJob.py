...
optP.add_option('--codeV', action='store', dest='codeV',
                default=None, help='kill code')
optP.add_option('--jobSubStatus', action='store', dest='jobSubStatus',
                default=None, help='set job sub status if any')
